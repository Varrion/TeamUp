...
public interface LocationService extends BaseGetDeleteService<LocationProjection, Long, Void>, BaseSaveUpdateService<LocationDto, Long>, BaseFileService<Long> {
